...
class MyLanguage(models.Model):
    user = models.ForeignKey(User, models.CASCADE, related_name='my_languages')
...
class MyLevel(models.Model):
    language = models.ForeignKey(MyLanguage, models.CASCADE, related_name='levels')
...
class MyUnit(models.Model):
    level = models.ForeignKey(MyLevel, models.CASCADE, related_name='units')
